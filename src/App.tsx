...
const SHOP_ITEMS: { id: string; emoji: string; name: string; cost: number; category: string; zone: 'ground' | 'sky' | 'roof' }[] = [
  // Furniture
  { id: 'sofa',        emoji: '🛋️',  name: 'Couch',         cost: 50,  category: 'Furniture',    zone: 'ground' },
  { id: 'bed',         emoji: '🛏️',  name: 'Bed',           cost: 60,  category: 'Furniture',    zone: 'ground' },
  { id: 'tv',          emoji: '📺',  name: 'TV',            cost: 80,  category: 'Furniture',    zone: 'ground' },
  { id: 'lamp',        emoji: '🪔',  name: 'Lamp',          cost: 25,  category: 'Furniture',    zone: 'ground' },
  { id: 'rug',         emoji: '🟫',  name: 'Rug',           cost: 30,  category: 'Furniture',    zone: 'ground' },
  { id: 'table',       emoji: '🪵',  name: 'Table',         cost: 35,  category: 'Furniture',    zone: 'ground' },
  { id: 'chair',       emoji: '🪑',  name: 'Chair',         cost: 20,  category: 'Furniture',    zone: 'ground' },
  { id: 'bookshelf',   emoji: '📚',  name: 'Bookshelf',     cost: 40,  category: 'Furniture',    zone: 'ground' },
  { id: 'desk',        emoji: '🖥️',  name: 'Desk',          cost: 45,  category: 'Furniture',    zone: 'ground' },
  { id: 'dresser',     emoji: '🗄️',  name: 'Dresser',       cost: 35,  category: 'Furniture',    zone: 'ground' },
  // Decorations
  { id: 'painting',    emoji: '🖼️',  name: 'Painting',      cost: 40,  category: 'Decorations',  zone: 'ground' },
  { id: 'poster',      emoji: '🎨',  name: 'Poster',        cost: 20,  category: 'Decorations',  zone: 'ground' },
  { id: 'plant',       emoji: '🪴',  name: 'Potted Plant',  cost: 15,  category: 'Decorations',  zone: 'ground' },
  { id: 'fishtank',    emoji: '🐠',  name: 'Fish Tank',     cost: 55,  category: 'Decorations',  zone: 'ground' },
  { id: 'clock',       emoji: '🕰️',  name: 'Wall Clock',    cost: 25,  category: 'Decorations',  zone: 'ground' },
  { id: 'trophy',      emoji: '🏆',  name: 'Trophy',        cost: 50,  category: 'Decorations',  zone: 'ground' },
  { id: 'window',      emoji: '🪟',  name: 'Window',        cost: 30,  category: 'Decorations',  zone: 'ground' },
  { id: 'curtains',    emoji: '🎀',  name: 'Curtains',      cost: 25,  category: 'Decorations',  zone: 'ground' },
  // Outdoors
  { id: 'tree',        emoji: '🌳',  name: 'Tree',          cost: 30,  category: 'Outdoors',     zone: 'ground' },
  { id: 'flowers',     emoji: '🌸',  name: 'Flowers',       cost: 20,  category: 'Outdoors',     zone: 'ground' },
  { id: 'fountain',    emoji: '⛲',  name: 'Fountain',      cost: 60,  category: 'Outdoors',     zone: 'ground' },
  { id: 'mailbox',     emoji: '📬',  name: 'Mailbox',       cost: 20,  category: 'Outdoors',     zone: 'ground' },
  { id: 'fence',       emoji: '🪧',  name: 'Fence',         cost: 25,  category: 'Outdoors',     zone: 'ground' },
  { id: 'trampoline',  emoji: '🤸',  name: 'Trampoline',    cost: 70,  category: 'Outdoors',     zone: 'ground' },
  { id: 'mushroom',    emoji: '🍄',  name: 'Mushroom',      cost: 15,  category: 'Outdoors',     zone: 'ground' },
  { id: 'pond',        emoji: '🪷',  name: 'Pond',          cost: 45,  category: 'Outdoors',     zone: 'ground' },
  // Pets
  { id: 'dog',         emoji: '🐶',  name: 'Dog',           cost: 80,  category: 'Pets',         zone: 'ground' },
  { id: 'cat',         emoji: '🐱',  name: 'Cat',           cost: 80,  category: 'Pets',         zone: 'ground' },
  { id: 'hamster',     emoji: '🐹',  name: 'Hamster',       cost: 50,  category: 'Pets',         zone: 'ground' },
  { id: 'parrot',      emoji: '🦜',  name: 'Parrot',        cost: 60,  category: 'Pets',         zone: 'ground' },
  { id: 'fish',        emoji: '🐟',  name: 'Fish',          cost: 30,  category: 'Pets',         zone: 'ground' },
  // Wallpaper & Floors
  { id: 'wp-stars',    emoji: '🌟',  name: 'Starry Walls',  cost: 40,  category: 'Wallpaper',    zone: 'ground' },
  { id: 'wp-clouds',   emoji: '☁️',  name: 'Cloud Walls',   cost: 35,  category: 'Wallpaper',    zone: 'ground' },
  { id: 'wp-brick',    emoji: '🧱',  name: 'Brick Walls',   cost: 30,  category: 'Wallpaper',    zone: 'ground' },
  { id: 'wp-wood',     emoji: '🪵',  name: 'Wood Panels',   cost: 35,  category: 'Wallpaper',    zone: 'ground' },
  { id: 'fl-check',    emoji: '♟️',  name: 'Checkerboard',  cost: 30,  category: 'Wallpaper',    zone: 'ground' },
  { id: 'fl-grass',    emoji: '🌿',  name: 'Grass Floor',   cost: 25,  category: 'Wallpaper',    zone: 'ground' },
  // Sky & Roof
  ...
  // Special / Rare
  { id: 'telescope',   emoji: '🔭',  name: 'Telescope',     cost: 120, category: '✨ Rare',      zone: 'ground' },
  { id: 'rocket',      emoji: '🚀',  name: 'Rocket Model',  cost: 150, category: '✨ Rare',      zone: 'ground' },
  { id: 'crystalball', emoji: '🔮',  name: 'Crystal Ball',  cost: 100, category: '✨ Rare',      zone: 'ground' },
  { id: 'gumball',     emoji: '🍬',  name: 'Gumball Machine',cost: 90, category: '✨ Rare',      zone: 'ground' },
  { id: 'treasure',    emoji: '💰',  name: 'Treasure Chest',cost: 200, category: '✨ Rare',      zone: 'ground' },
  { id: 'star',        emoji: '⭐',  name: 'Gold Star',     cost: 100, category: '✨ Rare',      zone: 'sky' },
]
